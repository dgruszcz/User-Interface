...
Drivers/STM32F4xx_HAL_Driver/Src/%.o: ../Drivers/STM32F4xx_HAL_Driver/Src/%.c
	...
	@echo %cd%
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 '-D__weak=__attribute__((weak))' '-D__packed=__attribute__((__packed__))' -DUSE_HAL_DRIVER -DSTM32F411xE -I"E:/User-Interface-master/Inc" -I"E:/User-Interface-master/Drivers/STM32F4xx_HAL_Driver/Inc" -I"E:/User-Interface-master/Drivers/STM32F4xx_HAL_Driver/Inc/Legacy" -I"E:/User-Interface-master/Drivers/CMSIS/Device/ST/STM32F4xx/Include" -I"E:/User-Interface-master/Drivers/CMSIS/Include"  -Og -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
